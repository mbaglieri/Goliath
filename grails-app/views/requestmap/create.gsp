...
<html>
    <head>
        ...
        <title><g:message code="default.create.label" args="[entityName]" default="Nuevo Requestmap"/></title>
    </head>
    <body>
    ...
    <hr class="space"/>
        ...
        <div class="body">
            <h1><g:message code="default.create.label" args="[entityName]" default="Nuevo Requestmap"/></h1>
