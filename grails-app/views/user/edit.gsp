...
<html>
	...
	<title><g:message code="default.edit.label" args="[entityName]" default="Editar User"/></title>
    </head>
    <body>
    ...
    <hr class="space"/>
		...
		<g:message code="default.list.label" args="[entityName]" default="Listado User"/></g:link>
	    </span>
            <span class="menuButton"><g:link class="create" action="create">
		<g:message code="default.new.label" args="[entityName]" default="Nuevo User" /></g:link>
	    </span>

        </div>
        <div class="body">
            <h1><g:message code="default.edit.label" args="[entityName]" default="Editar User"/></h1>
