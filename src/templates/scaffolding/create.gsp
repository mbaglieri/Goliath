...
<html>
    <head>
        ...
        <title><g:message code="default.create.label" args="[entityName]" default="Nuevo ${className}"/></title>
    </head>
    <body>
  	<div id="main" role="main">
        ...
        <div class="body">
            <h1><g:message code="default.create.label" args="[entityName]" default="Nuevo ${className}"/></h1>
